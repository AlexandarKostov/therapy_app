...
@section('hero')
        ...
        <span class="inline-block">If
            ...
            <span class="relative">you're looking</span></span>
        </span>
                <span class="inline-block">for support in your area, see how a nearby therapist can help.</span>
            </h1>

            <p class="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
                <span class="inline-block">Learn how to choose between a psychologist and a therapist.</span>
            </p>
            ...
            <div class="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
                <a class="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900 animate-fade-in-left"
                   href="#">
                    ...
                    <span class="ml-3">Start now</span>
                </a>
            </div>
        </div>
    <div>
            ...
            <div class="w-full grid grid-cols-4 gap-10">
                ...
                <div id="side-bar"
                     class="border-t border-t-gray-100 md:border-t-none col-span-4 md:col-span-1 px-3 md:px-6  space-y-10 py-6 pt-10 md:border-l border-gray-100 h-screen sticky top-0">
                        ...
                        @include('accesco-medical.blog.partials.article-box')
                </div>
            </div>
        </main>
    </div>
